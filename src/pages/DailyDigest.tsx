        ...
        {!loading && !generating && current && (
          <>
            ...
            <div className="grid gap-4 md:grid-cols-[320px_1fr] items-start transition-all duration-500">
              {/* TOC */}
              <Card id="digest-toc" className="p-4 md:p-5 md:sticky md:top-6 flex flex-col">
                ...
                <ScrollArea className="mt-4 -mx-2 px-2 h-[400px] md:h-auto md:max-h-[calc(100vh-12rem)]">
